...
- **WYSIWYG 編輯器**：支援 Milkdown 所見即所得編輯，同時支援 `-` 和 `*` 列表符號
...
詳細的安裝和部署指南請參考 **[INSTALL.md](INSTALL.md)**
...
cd sheltie
cd backend && go mod tidy && go run main.go    # 後端 :8080
